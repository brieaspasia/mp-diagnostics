...
BCnet = networkPlot(NetMatrix, weighted = NULL, n = 50, Title = "Papers' bibliographic coupling", type = "fruchterman", size = 5, remove.multiple = TRUE, labelsize = 0.5)
```
...
Tnet = networkPlot(NetMatrix, n = 30, Title = "Keyword co-occurance", type = "fruchterman", size = T, remove.multiple = FALSE, labelsize = 0.7, edgesize = 5)
```

```{r  conceptualStructure map, eval=TRUE}
#Authors
DE_CS <- conceptualStructure(bib, field = "DE", minDegree = 20, k.max = 5, stemming = FALSE, labelsize = 10)
```
