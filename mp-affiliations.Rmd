...
net=networkPlot(NetMatrix,  n = 75, Title = "Author Affiliations", normalize = "salton", label.n=10, type = "fruchterman", cluster="optimal", size=10, size.cex=T,edgesize = 3,labelsize=1, remove.multiple=F, remove.isolates=F)
