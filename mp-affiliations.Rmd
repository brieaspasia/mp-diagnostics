...
net=networkPlot(NetMatrix,  n = 50, Title = "Author Affiliations", normalize = "salton", label.n=10, type = "fruchterman", cluster="optimal", size=10, size.cex=T,edgesize = 3,labelsize=1, remove.multiple=F, remove.isolates=F)
...
plot(collab_graph, edge.arrow.size=.2, edge.curved=1)
```
...
# #Is this the instution collaborating with itself, in which case it should # #not be filtered out?
