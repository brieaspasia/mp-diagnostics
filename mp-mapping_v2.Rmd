...
MostProdCountries_World$article_prop <- (MostProdCountries_World$Articles/sum(MostProdCountries_World$Articles, na.rm = TRUE)) #if you multiply this by 100, it is percentage, not proportion
...
MostProdCountries_World %>%
  dplyr::arrange(desc(article_prop)) %>% top_n(6, article_prop) -> top6
...
tm_shape(MostProdCountries_World) + 
  tm_fill(col = "article_prop", palette="BuGn") +
  tm_borders(MostProdCountries_World$article_prop>=0.05, col = "black")
