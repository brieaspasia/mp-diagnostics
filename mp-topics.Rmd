...
wordcloud(out$Keyword,out$Linkscount, scale=c(2,.2),min.freq=50,
...
degree(gD) #print the number of edges per vertex (relationships per keyword)
```
...
bad.vs<-V(gD)[degree(gD)<100] #identify those vertices part of less than three edges
